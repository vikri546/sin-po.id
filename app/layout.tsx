...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: 'https://sinpo.id/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
      { url: 'https://sinpo.id/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
    ],
    shortcut: 'https://sinpo.id/sinpo-favicon.png',
    apple: [
      { url: 'https://sinpo.id/apple-touch-icon.png', sizes: '180x180', type: 'image/png' },
